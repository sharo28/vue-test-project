    ...
    stages {
        stage('Hello') {
            steps {
                ...
                sh 'npx swa deploy --verbose=silly --env production --deployment-token 2cf1a9fafee37b6b95972ab45bd36bb601ea3ea8a358c1a9524078dc78ce0c355-4f431a87-e2f2-4c6c-a047-c5ac431238e0000292686'
                sh 'az logout'
            }
        }
    }
